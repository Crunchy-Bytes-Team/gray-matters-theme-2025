  ...
  })()(
    {
      ...
      6: [
        function (require, module, exports) {
          ...
          var MailChimpError =
            /*#__PURE__*/
            (function (_Error) {
              _inherits(MailChimpError, _Error);

              function MailChimpError() {
                _classCallCheck(this, MailChimpError);

                return _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(MailChimpError).apply(this, arguments),
                );
              }
        ...
        function (require, module, exports) {
          ...
          var MailChimpSuccess =
            ...
            function MailChimpSuccess(message) {
              _classCallCheck(this, MailChimpSuccess);
      ...
      8: [
        function (require, module, exports) {
          ...
          var _MailChimpError = _interopRequireDefault(
            require('./MailChimpError'),
          );

          var _MailChimpSuccess = _interopRequireDefault(
            require('./MailChimpSuccess'),
          );
          ...
          var validateFields = function validateFields(_ref) {
            var email = _ref.email,
              ...
              uID = _ref.uID,
              audienceID = _ref.audienceID;
            if (!listName || listName.match(/\//))
              throw new Error(
                "Invalid value '".concat(
                  listName,
                  "' for 'listName', should be the subdomain section of 'list-manage.com'; https://mylist.us.list-manage.com/ -> 'mylist.us'",
                ),
              );
          ...
          var _default = function _default(_ref2) {
            ...
            var url = '//'.concat(listName, '.list-manage.com');
            var endpoint = '/subscribe/post-json';
                ...
                function (err, data) {
                  try {
                    ...
                    if (data.result === 'error')
                      throw new _MailChimpError.default(data.msg);
                    resolve(new _MailChimpSuccess.default(data.msg));
                  } catch (error) {
                    reject(error);
                  }
                },
        ...
        { './MailChimpError': 6, './MailChimpSuccess': 7, jsonp: 3 },
      ],
    },
    {},
    [8],
...
function handleMailchimpException(ex, callback) {
  var tokens = ex.toString().replace('Error: ', '').split(' - ');
  var field = tokens[0];
  var message = tokens[1];
  var err_message = ex.toString();

  if (typeof field !== 'undefined' && typeof message !== 'undefined') {
    if (field == 0) {
      field = 'Email';
    } else if (field == 1) {
      field = 'Name';
    ...
    err_message = field.toLowerCase() + ': ' + message.toLowerCase();
  }

  if (callback) callback(err_message);
}
...
function subscribeUser(
  ...
  try {
    mailchimp
      .default({
        email: email,
        uID: 'abe27aec3bc9a849c75e74514',
        audienceID: '23ebe051fd',
        listName: 'graymattersnyc.us11',
        customFields: {
          FNAME: name,
          MMERGE7: shoe_size,
          MMERGE1: name,
          MMERGE4: website_code,
        },
      })
      .then(function (res) {
      ...
      .catch(function (ex) {
        handleMailchimpException(ex, failure_callback);
      });
  } catch (ex) {
    handleMailchimpException(ex, failure_callback);
  }
