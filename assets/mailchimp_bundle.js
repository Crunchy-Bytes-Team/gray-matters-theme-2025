        ...
        function (require, module, exports) {
          ...
          function mixin(obj) {
            for (var key in RequestBase.prototype) {
              if (
                Object.prototype.hasOwnProperty.call(RequestBase.prototype, key)
              )
...
var _superagent2 = _interopRequireDefault(superagent);

//var _Campaigns = require('./Campaigns');

var _Campaigns2 = _interopRequireDefault(Campaigns);

//var _Lists = require('./Lists');

var _Lists2 = _interopRequireDefault(Lists);

//var _Members = require('./Members');

var _Members2 = _interopRequireDefault(Members);

//var _MergeFields = require('./MergeFields');

var _MergeFields2 = _interopRequireDefault(MergeFields);

//var _Segments = require('./Segments');

var _Segments2 = _interopRequireDefault(Segments);

//var _Webhooks = require('./Webhooks');

var _Webhooks2 = _interopRequireDefault(Webhooks);
...
var Mailchimp = (function () {
  function Mailchimp(username, apiKey) {
    ...
    this.endpoint =
      'https://' + this.datacenter + '.api.mailchimp.com/' + this.version;
  ...
  _createClass(Mailchimp, [
    {
      ...
      value: function call(http, method, params) {
        ...
        var req = (0, _superagent2.default)(http, '' + this.endpoint + method)
